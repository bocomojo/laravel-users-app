            ...
            <form action="{{ route('pdf.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded shadow">
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        multiple
                        class="mt-2 block w-full border border-gray-300 p-2 rounded shadow-sm focus:ring-blue-500 focus:border-blue-500">
                    @error('pdf_file.*')
                ...
                <div class="flex justify-end">
                    <button type="submit"
                        class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition duration-150 shadow">
                        Upload PDFs
                    </button>
                </div>
            </form>
